<div class="modal fade text-start modal-primary" id="tambahUniversitas" tabindex="-1" aria-labelledby="myModalLabel160" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel160">Tambah Universitas</h5>
            ...
            <div class="modal-body">
                <form id="formTambahProdi">
                    <div class="form-group mb-1">
                        ...
                        <select class="form-control select2" name="nama_universitas" id="namaUniversitas">
                    ...
                    <div class="form-group mb-1">
                        ...
                        <select class="form-control select2" name="nama_fakultas" id="fakultasId">
                                <option value="0">--Pilih Prodi--</option>
