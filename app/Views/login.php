...
<head>
    ...
    <title>SPK - Penentuan Juruan Kuliah</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-2 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="<?=base_url()?>/app-assets/values-3.png" alt="homepage" class="light-logo" /></div>
                            <div class="col-lg-6">
                                <div class="p-5">
